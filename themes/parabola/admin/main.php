...
include_once(dirname(__FILE__) . "/schemes.php");
}
...
/*** graphics ***/
	...
	add_settings_field('parabola_caption', __('Caption Border','parabola') , 'cryout_setting_caption_fn', __FILE__, 'graphics_section');
	add_settings_field('parabola_metaback', __('Meta Area Background','parabola') , 'cryout_setting_metaback_fn', __FILE__, 'graphics_section');
...
incompatible plugins.<br> The Parabola Settings page cannot function without jQuery. You need to fix this issue before you can configure Parabola.</div>
<script type="text/javascript"> jQuery('#jsAlert').hide();</script>
...
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
    ...
    <div class="postbox export non-essential-option" style="overflow:hidden;">
        ...
        <?php /* <form action="" method="post">
                    ...
                    <input type="submit" class="button" id="presets_button" value="<?php _e('Load Preset Color Schemes', 'parabola'); ?>" />
					<p style="display:block;float:left;clear:left;margin-top:0;"><?php _e("These are the presets bla would just be a fool's exercise. Make sure you have the exported file ready and see you after the mouse click.","parabola"); ?></p>
                </form> */ ?>
