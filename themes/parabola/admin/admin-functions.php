...
?>
    <div class="wrap">
		<div style="display:block;margin-left:30px;">
			<div id="icon-tools" class="icon32"><br></div>
			<h2><?php echo __( 'Parabola Presets', 'parabola' );?></h2>
	...
	?>
			...
			<div id="submitDiv" style="width:400px;display:block;margin:0 auto;">
				<br>
				<input class="button" name="parabola_settings[parabola_schemessubmit]" type="submit" style="width:400px;height:40px;display:block;text-align:center;" value="<?php _e('Load Preset','parabola'); ?>" />
			</div>
			</form>
		</div>
    </div> <!-- end wrap -->
